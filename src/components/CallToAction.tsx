      ...
      <div className="container px-4 sm:px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg mb-8 text-white/90 max-w-2xl mx-auto">
            LIFE is important and YOU are important. Whether through donations, volunteering, or spreading awareness, your support helps us save pedestrian lives across India.
          </p>
          ...
          <div className="mt-10 pt-8 border-t border-white/20 text-sm text-white/80 flex flex-col sm:flex-row justify-center items-center gap-4">
            <p>100% of your donation goes directly to pedestrian safety programs.</p>
